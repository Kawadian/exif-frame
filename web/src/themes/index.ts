...
import { TWO_LINE_FUNC, TWO_LINE_OPTIONS } from './05_TWO_LINE';
...
import { SHOT_ON_ONE_LINE_FUNC, SHOT_ON_ONE_LINE_OPTIONS } from './06_SHOT_ON_ONE_LINE';
import { SHOT_ON_TWO_LINE_FUNC, SHOT_ON_TWO_LINE_OPTIONS } from './07_SHOT_ON_TWO_LINE';
import { FILM_FUNC, FILM_OPTIONS } from './09_FILM';
import { MONITOR_FUNC, MONITOR_OPTIONS } from './10_MONITOR';
